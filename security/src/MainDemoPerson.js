                    ...
                    <div className="form">
                        <div className="video-info">
                            <p>
                                ...
                                The map would then display the path of the corresponding phone signal.
                                This could be implemented with the google maps API in combination with the Waypoints API.
                            </p>
                        </div>
